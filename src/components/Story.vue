...
defineComponent({name: 'StoryComponent'});
</script>
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="relative timeline-item pb-16" data-aos="fade-right">
          <div
              class="timeline-date absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-50 px-4 py-2 rounded-full border border-primary text-primary font-medium z-10 md:left-0 md:translate-x-0 hover:scale-110 hover:bg-primary hover:text-white transition-all duration-300 cursor-pointer">
            2018
          </div>
        ...
        <!-- Timeline item 3 -->
        <div class="relative timeline-item" data-aos="fade-right" data-aos-delay="200">
          <div
              class="timeline-date absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-50 px-4 py-2 rounded-full border border-primary text-primary font-medium z-10 md:left-0 md:translate-x-0 hover:scale-110 hover:bg-primary hover:text-white transition-all duration-300 cursor-pointer">
            2024
          </div>
